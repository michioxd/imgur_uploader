...
// by michio kawaii~
// License: MIT License
// https://github.com/michioxd/imgur_uploader
...
?>
        ...
        <div style="text-align: center;">
            <h5 style="margin-top:0;font-size:16px">YOUR IMGUR LINK</h5>
...
<head>
    ...
    <title>Imgur Uploader with Dropzone.js</title>
    ...
    <style>
        * {
        ...
        body {
            background-image: url(https://i.imgur.com/M6KIxwS.jpg);
    ...
    <div class="mdl-layout mdl-layout--fixed-header mdl-js-layout ">
        <header class="mdl-layout__header mdl-layout__header--scroll mdl-color-text--grey-800">
            <div class="mdl-layout__header-row">
                <span class="mdl-layout-title">Imgur Uploader with Dropzone.js</span>
                <div class="mdl-layout-spacer"></div>
                <a style="color:#000;margin:5px;font-size:45px" href="https://fb.com/michio.xd" target="_blank">
                    <span style="font-size: 28px;" class="material-icons">facebook</span>
                </a>
                <a href="https://github.com/michioxd/imgur_uploader" target="_blank">
                    <img src="https://raw.githubusercontent.com/michioxd/imgur_uploader/main/github.svg" alt="" width="24px" srcset="">
                </a>
            </div>
        </header>
        <div class="wrapper mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
            <div style="text-align:center">
                <h5>UPLOAD IMAGEEEEEEEE</h5>
            </div>
            <form action="?upload" class="dropzone" id="DropzoneFrom"></form>
            <button class="upload_file mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored">
                Upload now!
            </button>
            <div class="output"></div>
        </div>
        <footer>
            <p>&copy; 2021 by michio nakano<br>
                Artwork: <a href="https://www.pixiv.net/en/artworks/86526306" target="_blank">https://www.pixiv.net/en/artworks/86526306</a></p>
            <p>i'm a lolicon :<, please don't call fbi :< </p>
        </footer>
    </div>
</body>
<script>
